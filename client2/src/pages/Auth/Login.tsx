    ...
    <>
      ...
      <div className="h-screen flex flex-col items-center justify-center bg-gray-100 p-5 dark:bg-gray-800 dark:text-white">
        ...
        <div className="grid grid-cols-2 border border-gray-300 HeadingH3 w-400 bg-slate-50 rounded-2xl text-left mt-10 mb-10">
          <div><img src={ArticleIcon} alt="Ticket" className="w-20 h-20" /></div>
          <div className='grid grid-cols-1 text-left'>
            <span className="text-slate-500 text-l font-normal font-['DM Sans'] leading-6">지금 가입하면 </span>
            <span className="text-indigo-600 text-l font-normal font-['DM Sans'] leading-4">아티클 열람권 3회 티켓</span>
            <span className="text-slate-500 text-l font-normal font-['DM Sans'] leading-4">을 받을 수 있어요!</span>
          </div>
        </div>
