  ...
  return (
    <>
      ...
      <div className="w-[286px] h-[59px] rounded-lg border border-scampi-200 grid grid-cols-[1fr_3fr] items-center mt-5">
        ...
        <div className='text-scampi-800'>지금 가입하면 <span className="text-indigo-600 font-bold">아티클 열람권 3회 티켓</span>을 받을 수 있어요!</div>
      </div>

        {/* 카카오 가입 버튼 */}
        <div className='flex gap-4 mt-4'>
        <button onClick={handleLogin} className="w-[400px] h-[59px] px-6 py-4 text-base text-white bg-scampi-600 rounded-full">
          카카오로 3초만에 시작하기
        </button>
        </div>
