...
import KakaoIcon from '../../Icon/kakao_login_large_narrow.png';
  ...
  return (
    <>
      <div className="h-screen flex flex-col items-center justify-center bg-gray-100 p-5 dark:bg-gray-800 dark:text-white">
        ...
        {/* 카카오 로그인 버튼 */}
        <button onClick={handleLogin} className="w-[400px] h-[59px] rounded-full mt-4">
        ...
        >
          <img src={Email} className="w-6 h-6 mr-4" alt="Email Icon" />이메일 로그인
        </button>
