...
const SignupForm2 = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100 p-5">
      <h1 className="text-xl font-bold text-scampi-600 mb-5">
        이메일과 비밀번호 입력하기
      </h1>
    <form onSubmit={handleSignup} className="flex flex-col w-full max-w-lg mx-auto">
      ...
      <div className="flex justify-between mt-4">
        <Link to="/signup3" className="text-teal-500 hover:text-teal-700 transition-colors duration-300">로그인</Link>
      </div>
    </form>
    </div>
    </>
